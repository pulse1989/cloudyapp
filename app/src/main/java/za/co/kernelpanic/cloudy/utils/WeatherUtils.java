...
public final class WeatherUtils {
     ...
     * <p>
     * {@link #getLargeCurrentWeatherArt(int)} (int)}.
     * <p>
     ...
     */
    public static int getLargeCurrentWeatherArt(int weatherId) {

        /*
         * Based on weather code data for Open Weather Map.
         */
        if (weatherId >= 200 && weatherId <= 232) {
            return R.drawable.ic_wi_thunderstorms_dark;
        } else if (weatherId >= 300 && weatherId <= 321) {
            return R.drawable.ic_wi_cloudy_light_rain_dark;
        } else if (weatherId >= 500 && weatherId <= 504) {
            return R.drawable.ic_wi_heavyrain;
        } else if (weatherId == 511) {
            return R.drawable.ic_wi_light_snow;
        } else if (weatherId >= 520 && weatherId <= 531) {
            return R.drawable.ic_wi_rain_thunder;
            ...
            return R.drawable.ic_wi_sunny;
        } else if (weatherId == 801) {
            return R.drawable.ic_wi_sunny_cloudy;
        } else if (weatherId >= 802 && weatherId <= 804) {
            return R.drawable.ic_wi_cloudy_dark;
